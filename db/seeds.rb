...
all_users = [elea, alexis, sherazade]
...
9.times do
  Booking.create!(user: all_users.sample, organ: all_organs.sample, availability: [0, 1, 2].sample)
end
...
8.times do
  Review.create!(comment: Faker::TvShows::GameOfThrones.quote, rating: rand(0..5), organ: all_organs.sample)
end
